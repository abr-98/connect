...
class Fill_detail extends Component {
   ...
   contactSubmit(e){
    ...
    var data = {
      ...
      works_at: this.state.works_at,
      institute: this.state.institute,
      working_post: this.state.working_post,
  }
  fetch("/user_details/new", {
    method: 'post',
  ...
  handleChange(field, e){         
   ...
   render()
   {
        ...
        return (
          ...
          <form class="fill_details" onSubmit= {this.contactSubmit.bind(this)} method="post" action="/new">
            <input
              type="text"
              name="fname"
              class="first"
